...
<p style="margin-bottom: 5px;"><strong>👉 Click "Run" or press Shift+Enter to execute.</strong></p> <textarea id="sql" style="width:100%;height:160px;font-family:ui-monospace,monospace;padding:10px;"> -- Top 10 Airports by Connectivity SELECT iata, deg_total as total_routes FROM airport_degree ORDER BY total_routes DESC LIMIT 10; </textarea> </div>
